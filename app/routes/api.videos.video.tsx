...
export const loader: LoaderFunction = async ({request}) => {
  ...
  url.searchParams.append(
    "extra_params",
    "ssl,show,gif,urltitle,source_id,description,keywords,fullimage,verticalimage,category,other_category,tmpcheck,newurl,ssl,sitelink,shorttitle,filepath,folder_path,preview,vertical,alias,aliasInit,author,content_type,network,modified"
  );
