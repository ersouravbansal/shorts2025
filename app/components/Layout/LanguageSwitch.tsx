...
//                 <input type="radio" id="english" name="lanbtn" defaultValue="English" className="langchoice" data-value="en" />
//                 <button className="SchLng_btn-slect">
//                   <div className="SchLng_btn-wr">
//                     <span className="SchLng_btn-slected"><svg className="checkmark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52">
...
//                 <input type="radio" id="hindi" name="lanbtn" defaultValue="Hindi" className="langchoice" data-value="hi" />
//                 <button className="SchLng_btn-slect">
//                   <div className="SchLng_btn-wr">
...
//                 <input type="radio" id="rj" name="lanbtn" defaultValue="Rajasthan" className="langchoice" data-value="rj" />
//                 <button className="SchLng_btn-slect">
//                   <div className="SchLng_btn-wr">
//                     <span className="SchLng_btn-slected">
//                       <svg className="checkmark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52">
...
//                 <input type="radio" id="mp" name="lanbtn" defaultValue="Chattisgarh" className="langchoice" data-value="mp" defaultChecked="checked" />
//                 <button className="SchLng_btn-slect">
//                   <div className="SchLng_btn-wr">
//                     <span className="SchLng_btn-slected">
//                       <svg className="checkmark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52">
...
//               <a href="javascript:void()" className="SchLng_subBtn-lnk">Continue</a>
//               <a href="javascript:void()" className="SchLng_subBtn-lnk SchLng_skp-btn">Skip</a>
//             </div>
//           </div>
//         </div>
//       </div>
