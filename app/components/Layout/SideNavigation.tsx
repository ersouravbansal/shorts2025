...
const SideNavigation = (props: any) => {
  ...
  // const domainUrl= getApiUrl(url)
  const setSidenavtoggle = useStore((state) => state.setSidenavtoggle);
  const setBackLink = useStore((state) => state.setBackLink);
  const [khabarLink, setKhabarLink] = useState(null);
  let khabarLinkValue: any;
  let backLinkValue: any;
  ...
  const getIcon = (title: any) => {
    const icons: any = {
      ...
      Movies: "vj_movies",
      Cricket: "vj_cricket",
      Notifications: "vj_notification",
      Opinion: "vj_opinion",
      "Web Stories": "vj_amp-stories",
      Trends: "vj_trends",
      Feature: "vj_featured",
      Offbeat: "vj_offbeat",
      Cities: "vj_cities",
      ...
      People: "vj_people",
      South: "vj_south",
      Education: "vj_education",
      Tech: "vj_gadgets",
      Food: "vj_food",
      Sports: "vj_sports",
      Health: "vj_doctor",
      Swirlster: "vj_swirlster",
      Photos: "vj_photos",
      "TV Schedule": "vj_tv-schedule",
      "Big Bonus": "bigbonus",
      Shopping: "vj_shopping-icon",
      Toolbox: "ultimate-tool",
      Elections:"vj_elections",
      ताजातरीन: "vj_latest",
      "लाइव टीवी": "vj_live-tv",
      बॉलीवुड: "vj_movies",
      नोटिफिकेशन: "vj_notification",
      // देश: "vj_india",
      देश: "vj_gindia",
      "ज़रा हटके": "vj_offbeat",
      "बजट 2024": "vj_budget",
      वीडियो: "vj_videos",
      फूड: "vj_food",
      "वेब स्टोरी": "vj_amp-stories",
      "ओलंपिक 2024": "olympic",
      शॉपिंग: "vj_shopping-icon",
      फोटो: "vj_photos",
      "टूल बॉक्स": "ultimate-tool",
      हेल्‍थ: "vj_doctor",
      लाइफस्टाइल: "vj_swirlster",
      जॉब्‍स: "vj_news",
      करियर: "vj_study",
      बिज़नेस: "vj_profit",
      दुनिया: "vj_world_web",
      ब्लॉग: "vj_opinion",
      शहर: "vj_cities",
      "उत्तर प्रदेश": "vj_cities",
      बिहार: "vj_cities",
      "मध्य प्रदेश": "vj_cities",
      राजस्थान: "vj_cities",
      राशिफल: "vj_astrology-icn",
      "टीवी पर क्या देखें": "vj_tv-schedule",
      "आस्था": "vj_news",
      "चुनाव":"vj_elections"
    };
    return icons[title] || "";
  ...
  const handleSearch = async (e) => {
    ...
    // window.location.href = `/shorts/search/?q=` + query;
    // window.location.href = `https://www.ndtv.com/search?searchtext=` + query;
  };
  ...
  const clearSearch = (e) => {
    // console.log("clear saearch called")
    setQuery("");
    setShowClearButton(false);
  };

  useEffect(() => {
    //let language = getLanguageFromDomain(window.location.hostname)
    ...
    async function fetchMenuData() {
      ...
      try {
        ...
        // console.log("menu data: ", language, data);
        const sections: any = {};
        data.forEach((item: any) => {
          if (!sections[item.Desc]) {
            sections[item.Desc] = [];
          }
          sections[item.Desc].push({ Title: item.Title, Link: item.Link });
        });
  ...
  useEffect(() => {
    ...
    if (domain.endsWith(".app")) {
      ...
      setIsEng(false);
      khabarLinkValue = `${props.REMIX_DOMAIN_ENG}${BASEPATH}`;
      backLinkValue = `${props.REMIX_DOMAIN_HINDI}${BASEPATH}`;
      setLogoEnglish(false);
    }
    // console.log("khabar link value", khabarLinkValue);
    setKhabarLink(khabarLinkValue);
    setBackLink(backLinkValue);
  }, []);
  return (
    <>
      {/*======[ Side Navigation ]======*/}
          ...
          <div className="sid-nav_wrp">
            ...
            <form className="srh_inp-wrp" name="search" onSubmit={handleSearch}>
              ...
              <input
                className="srh_inp"
                type="text"
                placeholder={isEng?("Search for more videos"):("अन्य वीडियो खोजें")}
                autoComplete="off"
                value={query}
                  ...
                  <ul className="snv_cn-ul">
                    <li className="snv-two">
                      ...
                      <ul className="snv_cn-ul">
                        ...
                        {!isEng?( <li className="snv_cn-li">
                          <a
                            className="snv_cn-lnk ripple"
                            href="https://whatsapp.com/channel/0029Va4W2Dn6GcG6c6XL9s38"
                            target="_blank"
                          >
                            <div className="snv_ic-wrp">
                              <svg className="vj_icn vj_SN-linkedin">
                                <use xlinkHref="#whatsapp-icn" />
                              </svg>
                            </div>{" "}
                            WhatsApp
                          </a>
      ...
      >
        <defs>
          ...
          <symbol id="vj_gindia" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 66 74">
          ...
          {/* <!-- vj_business --> */}
          <symbol id="vj_profit" viewBox="0 0 32 32">
          ...
          <symbol id="vj_facebook" viewBox="0 0 32 32">
            <path d="M12.185 7.178v3.965h-2.905v4.849h2.905v14.408h5.967v-14.408h4.004c0 0 0.375-2.325 0.557-4.867h-4.539v-3.315c0-0.495 0.651-1.162 1.294-1.162h3.251v-5.048h-4.42c-6.262-0-6.115 4.853-6.115 5.578z"></path>
          </symbol>
          ...
          >
            <path
              ...
              transform="translate(-20.98 -111.14)"
            ></path>
          </symbol>
          ...
          <symbol
            id="vj_trends"
            xmlns="https://www.w3.org/2000/svg"
            viewBox="0 0 247.47 297.48"
          >
            <path
              id="Page-1"
